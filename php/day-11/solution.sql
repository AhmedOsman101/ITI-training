...
SELECT dnum, dname FROM department WHERE department.mgrssn = 968574;
...
SELECT d.* FROM department d JOIN employee e ON d.dnum = e.dno WHERE e.ssn = ( SELECT MIN(ssn) FROM employee );
...
-- but don’t enter any value for salary or super number to him.

INSERT INTO employee (fname, lname, ssn, bdate, address, gender, dno) VALUES ('besto', 'friendo', 102660, '2005-12-15', 'Nasr City, Cairo', 'm', 30);
